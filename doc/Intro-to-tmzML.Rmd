...
![Speed comparison between various load methods, showing the new tmzML type to be faster than other methods for most functions and requiring several orders of magnitude less memory.](../vignettes/figures/speedsizecomp.png){width=100%}
...
might feels similar but they're very different internally. We'll use a couple
